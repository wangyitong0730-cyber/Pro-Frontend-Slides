...
Advanced presentation systems for Pro Frontend Slides. Use this file as a feature reference when the user wants higher-impact presentation controls, stronger motion systems, or live-presenting tools.

## When To Read This File

Read this file when the user asks for, or would clearly benefit from:
- fragment reveals
- cinematic page transitions
- live theme switching
- settings or presentation controls
- drawing / annotation mode
- animated metrics or charts
- stronger print / export behavior

Do not treat every feature here as mandatory. Match the implementation to the request.

Verified, production-ready code for enhanced presentation features. Include these based on user selections in Phase 1.

## Feature Selection Guide

Use this quick map before diving into the implementation sections:

| Feature | Use it when | Keep it lighter when |
|---|---|---|
| **Fragments** | the speaker needs controlled pacing or step-by-step explanation | the deck should feel fast, static, or minimal |
| **Transitions** | the deck needs cinematic movement between slides | motion should stay subtle or restrained |
| **Theme switching** | the presentation may be shown in different settings or visual moods | the deck has a single tightly controlled brand look |
| **Settings panel** | the presenter wants live control over display behavior | the output should stay extremely lightweight |
| **Drawing mode** | live teaching, demos, walkthroughs, or annotation-heavy presenting | the deck is meant only for passive viewing |
| **Data animations** | metrics and charts are central to the story | numbers are secondary and static presentation is enough |
